...
<?php include "includes/header.php" ?>
	...
	<main class="main--artists" id="artists">
		...
		<article class="article--artists profile">
				...
				<p>
		Han har stået i lære hos HP, men har brugt det meget af hans hverdag i selvskab med Jonas og et bagland i graffiti miljøet, hvilket har afspejlet sig i hans tidligere arbejde. Han har sidenhen bevæget sig i sin helt egen retning, og specialiserer hovedsageligt i blackandgrey med fine streger, dotwork og sans for detaljer.
Simon er i dag medejer af Århus-shoppen.
